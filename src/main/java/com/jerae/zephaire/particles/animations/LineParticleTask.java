...
public class LineParticleTask implements AnimatedParticle {
    ...
    public String getDebugInfo() {
        ...
        info.append(ChatColor.AQUA).append("Player Nearby: ").append(formatBoolean(PerformanceManager.isPlayerNearby(startPoint))).append("\n");
        info.append(ChatColor.AQUA).append("Conditions Met: ").append(formatBoolean(conditionManager.allConditionsMet(startPoint))).append("\n");
