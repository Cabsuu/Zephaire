...
import com.jerae.zephaire.particles.animations.AnimatedSpiralParticleTask;
...
public class AnimatedSpiralParticleFactory extends AbstractAnimatedParticleFactory {
    @Override
    protected AnimatedParticle createParticleTask(Zephaire plugin, ConfigurationSection section, ConditionManager manager, World world, int loopDelay) {
        ...
        return new AnimatedSpiralParticleTask(base, particle, startRadius, endRadius, height, speed, verticalSpeed, period, startAngle, options, pitch, yaw, bounce, manager, collisionEnabled, despawnTimer, hasGravity, loopDelay);
    }
}
