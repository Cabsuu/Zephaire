...
public class CircleParticleFactory extends AbstractAnimatedParticleFactory {
    ...
    protected AnimatedParticle createParticleTask(Zephaire plugin, ConfigurationSection section, ConditionManager manager, World world, int loopDelay) {
        ...
        return new CircleParticleTask(plugin, center, particle, radius, speed, particleCount, options, pitch, yaw, manager, collisionEnabled, despawnTimer, hasGravity, loopDelay);
    }
}
