...
public class StaticCurveParticleTask extends BukkitRunnable implements Debuggable {
    ...
    public void run() {
        ...
        World world = centerReference.getWorld();
    ...
    public String getDebugInfo() {
        ...
        info.append(ChatColor.AQUA).append("Player Nearby: ").append(ParticleUtils.formatBoolean(PerformanceManager.isPlayerNearby(centerReference))).append("\n");
        info.append(ChatColor.AQUA).append("Conditions Met: ").append(ParticleUtils.formatBoolean(conditionManager.allConditionsMet(centerReference))).append("\n");
